...
$$.main_draw = {"":
 ...
 super: "Closure",
 $call$1: function(t) {
  if (typeof t !== 'number') return this.$call$1$bailout(1, t);
  this.context_1.clearRect$4(0, 0, 512, 512);
  this.stats_0.begin$0();
  for (var i = 0; i < 2000; ++i) {
    var x = $.add($.mul($.Math_cos(t + i * 0.01), 196), 256);
    var y = $.add($.mul($.Math_sin(t + i * 0.01234), 196), 256);
 ...
 $call$1$bailout: function(state, t) {
  this.context_1.clearRect$4(0, 0, 512, 512);
  this.stats_0.begin$0();
  for (var i = 0; i < 2000; ++i) {
    var x = $.add($.mul($.Math_cos($.add(t, i * 0.01)), 196), 256);
    var y = $.add($.mul($.Math_sin($.add(t, i * 0.01234)), 196), 256);
    this.context_1.beginPath$0();
    this.context_1.arc$6(x, y, 10, 0, 6.283185307179586, true);
    this.context_1.fill$0();
  }
