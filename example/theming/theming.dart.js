...
$$.main_draw = {"":
 ...
 call$1: function(t) {
  if (typeof t !== 'number')
    return this.call$1$bailout(1, t);
  var t1 = this.context_1;
  t1.clearRect$4(0, 0, 512, 512);
  var t2 = this.stats_0;
  t2.begin$0();
  for (var i = 0; i < 2000; ++i) {
    var x = $.cos(t + i * 0.01) * 196 + 256;
    var y = $.sin(t + i * 0.01234) * 196 + 256;
    t1.beginPath$0();
    t1.arc$6(x, y, 10, 0, 6.283185307179586, true);
    t1.fill$0();
  }
  t2.end$0();
 ...
 call$1$bailout: function(state, t) {
  ...
  t2.begin$0();
  for (var i = 0; i < 2000; ++i) {
    var x = $.cos($.add(t, i * 0.01)) * 196 + 256;
    var y = $.sin($.add(t, i * 0.01234)) * 196 + 256;
    t1.beginPath$0();
    t1.arc$6(x, y, 10, 0, 6.283185307179586, true);
    t1.fill$0();
  }
